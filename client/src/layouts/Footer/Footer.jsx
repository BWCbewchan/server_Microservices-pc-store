...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    "Products": [
      { name: "Custom Builds", link: "/catalog?category=Custome%20Builds" },
      { name: "Laptops", link: "/catalog?category=MSI%20Laptops" },
      { name: "Desktop PCs", link: "/catalog?category=Desktops" },
      { name: "Gaming Monitors", link: "/catalog?category=Gaming%20Monitors" },
      { name: "All Products", link: "/catalog" },
    ],
  };
